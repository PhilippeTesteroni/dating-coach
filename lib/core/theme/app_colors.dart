...
abstract class AppColors {
  // Background
  static const Color background = Color(0xFFCFC4BA);
  ...
  // Input (для полей ввода — чуть светлее фона)
  static const Color inputBackground = Color(0xFFDDD4CB);
  ...
  // Border
  static const Color border = Color(0xFFE0D6CC);
}
